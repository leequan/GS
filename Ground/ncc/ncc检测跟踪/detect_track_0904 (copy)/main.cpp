...
//    printf("Convert image in %f seconds.\n", sec(clock()-time));
...
int main(int argc, char * argv[])
{
    ...
    char *datacfg = "tiny-yolo_oneClass/voc.data";
    char *cfgfile = "tiny-yolo_oneClass/tiny-yolo.cfg";
    char *weightfile = "tiny-yolo_oneClass/tiny-yolo.backup";
