...
char track(unsigned char* pSource_data,char o,int dx,int dy,int ww,int hh,TargetData_TYPE &TargetData_Parameter2)
{
    int i;
    ...
    if(o==1)
    {
        ...
        TargetData_Parameter2 = TargetData_Parameter;
